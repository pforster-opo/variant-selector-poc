...
import variantsResponse from './bp90036796-variants.json'

/**
 * bp10004401 - BP with many variants
 * bp4227900  - BP with purely configurable articles
 * bp90038248 - BP with configurable articles and STO articles
 * bp90036796 - combined attribute Farbe/Oberfläche
 * bp90036969 - range attribute Zylinderüberstand
 * bp10027176 - multi-value attribute Anschlag and combined attribute Stulp L/B/S 
 */
